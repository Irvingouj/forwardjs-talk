...
import { CitiesView, CitiesViewLoadingStatus } from '@/modules/home/ui/views/cities-view';
import { SliderViewLoadingStatus, SliderView } from '@/modules/home/ui/views/slider-view';
...
const page = async () => {
  ...
  void queryClient.prefetchQuery(trpc.home.getCitySets.queryOptions({ limit: 9 }));
