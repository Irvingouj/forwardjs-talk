...
const TextScroll = ({ children, className, pauseOnHover = false }: TextScrollProps) => {
  ...
  return (
    ...
    >
      ...
      <div aria-hidden className="flex min-w-full shrink-0 justify-end gap-4 animate-marquee">
        {children}
      </div>
