...
export function ChartAreaView() {
  ...
  const peakMonth = React.useMemo(() => {
    ...
    const peak = photosCountByMonth.reduce((max, item) => (item.count > max.count ? item : max));
    return {
          ...
          <AreaChart data={chartData}>
            <defs>
              <linearGradient id="fillPhotos" x1="0" y1="0" x2="0" y2="1">
                ...
                <stop offset="95%" stopColor="var(--color-photos)" stopOpacity={0.1} />
              </linearGradient>
            </defs>
            ...
            <ChartTooltip
              ...
              content={
                <ChartTooltipContent
                  ...
                  formatter={(value) => [`${value} photo${value !== 1 ? 's' : ''}`, 'Photos']}
                  indicator="dot"
                />
              }
            />
