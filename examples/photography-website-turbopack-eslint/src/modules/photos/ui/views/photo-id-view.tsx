...
const MapboxComponent = dynamic(() => import('@/modules/mapbox/ui/components/map'), {
  ssr: false,
  loading: () => (
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6 flex items-baseline justify-between gap-4">
          <div>
            ...
            {takenAt && <p className="text-sm text-muted-foreground">Taken on {takenAt}</p>}
          </div>
        </div>
                      ...
                      <FormItem className="flex flex-col justify-between gap-2">
                        <div className="flex items-center justify-between gap-4">
                          ...
                          <div className="flex items-center gap-2 text-sm text-muted-foreground">
                            <span>{field.value === 'public' ? 'Public' : 'Private'}</span>
                            <FormControl>
                              <Switch
                ...
                <div className="space-y-4 border-t pt-4">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">
                      Auto-filled from EXIF when available. You can edit these values.
                    </p>
                  </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <ApertureSelector value={field.value} onChange={field.onChange} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <ShutterSpeedSelector value={field.value} onChange={field.onChange} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <ISOSelector value={field.value} onChange={field.onChange} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              setCurrentLocation((prev) => ({
                                lat: numericValue ?? prev?.lat ?? data.latitude ?? null,
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              setCurrentLocation((prev) => ({
                                ...
                                lng: numericValue ?? prev?.lng ?? data.longitude ?? null,
                              }));
                            }}
                ...
                >
                  <MapboxComponent
                    ...
                    initialViewState={{
                      ...
                      zoom: currentLocation?.lat != null && currentLocation?.lng != null ? 10 : 2,
                    }}
