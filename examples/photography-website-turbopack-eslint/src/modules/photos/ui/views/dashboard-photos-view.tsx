...
export const DashboardPhotosView = () => {
  ...
  const { data } = useSuspenseQuery(trpc.photos.getMany.queryOptions({ ...filters }));
  ...
  return (
    <Empty className="border border-dashed">
      <EmptyHeader>
        ...
        <EmptyDescription>You have no photos. Upload some photos to get started.</EmptyDescription>
      </EmptyHeader>
      <EmptyContent>
