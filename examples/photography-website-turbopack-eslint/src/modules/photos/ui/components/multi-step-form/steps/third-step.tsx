...
export function ThirdStep({
  ...
  }, [currentLocation.lat, currentLocation.lng, initialLatitude, initialLongitude]);
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs">
                {currentLocation.lat !== 0 && currentLocation.lng !== 0
                  ? formatGPSCoordinates(currentLocation.lat, currentLocation.lng)
                  : 'Drag the marker to set location'}
              </span>
            </div>
            {addressData?.features?.[0] && (
              <div className="text-xs">📍 {addressData.features[0].properties.place_formatted}</div>
            )}
          </div>
        </FormItem>
