          ...
          {!url || !imageInfo ? (
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Button type="button" variant="outline" size="sm" onClick={() => onReupload(url)}>
                  Re-upload
                </Button>
              </div>
              ...
              <div className="space-y-2">
                ...
                <InputGroup>
                  <InputGroupInput value={keyToImage(url)} readOnly className="font-mono text-xs" />
                  <InputGroupAddon align="inline-end">
                    <InputGroupButton onClick={handleCopyUrl} size="icon-xs" aria-label="Copy URL">
                      {isCopied ? (
