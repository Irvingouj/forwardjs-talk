...
export function UploadZone({ isUploading, onUpload, uploadProgress }: UploadZoneProps) {
  ...
  return (
    <div className="w-full flex flex-col items-center space-y-4">
      ...
      <div className="text-center space-y-2">
        <h1 className={cn(isUploading && 'opacity-50')}>Drag and drop photo file to upload</h1>
