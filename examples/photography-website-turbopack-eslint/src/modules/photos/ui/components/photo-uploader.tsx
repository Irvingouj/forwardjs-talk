...
interface PhotoUploaderProps {
  onUploadSuccess?: (url: string, exif: TExifData | null, imageInfo: TImageInfo) => void;
  folder?: string;
...
export function PhotoUploader({ onUploadSuccess, folder }: PhotoUploaderProps) {
  ...
  return (
    <UploadZone isUploading={isUploading} onUpload={handleUpload} uploadProgress={uploadProgress} />
  );
}
