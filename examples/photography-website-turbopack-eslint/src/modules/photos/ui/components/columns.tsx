...
export const columns: ColumnDef<photoGetMany[number]>[] = [
  ...
  },
  {
    ...
    header: 'Favorite',
    cell: ({ row }) => {
      return <FavoriteToggle photoId={row.original.id} initialValue={row.original.isFavorite} />;
    },
  },
  {
    ...
    cell: ({ row }) => {
      return (
        <div className="flex items-center gap-2">
          <DeletePhotoButton photoId={row.original.id} photoTitle={row.original.title} />
