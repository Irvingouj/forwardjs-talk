...
const STANDARD_EV_VALUES = [
  -5.0, -4.67, -4.33, -4.0, -3.67, -3.33, -3.0, -2.67, -2.33, -2.0, -1.67, -1.33, -1.0, -0.67,
  -0.33, 0.0, 0.33, 0.67, 1.0, 1.33, 1.67, 2.0, 2.33, 2.67, 3.0, 3.33, 3.67, 4.0, 4.33, 4.67, 5.0,
];
...
export function ExposureCompensationSelector({
  ...
  const [isCustom, setIsCustom] = useState(value !== undefined && closestEV === null);
  ...
  return (
    <div className="space-y-2">
      ...
      >
        <SelectTrigger>
          <SelectValue placeholder="Select exposure compensation">{displayValue}</SelectValue>
        </SelectTrigger>
      ...
      {isCustom && (
        <div className="flex gap-2 items-center">
          <Input
            ...
            className="flex-1"
          />
          <span className="text-sm text-muted-foreground whitespace-nowrap">EV</span>
