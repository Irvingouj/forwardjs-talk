...
import { AlignCenter, AlignLeft, AlignRight, Copy, MoreVertical, Trash } from 'lucide-react';
        ...
        ({ commands }) => {
          return commands.insertContent({
            ...
            attrs: {
              ...
              scrollZoom: options.scrollZoom !== undefined ? options.scrollZoom : true,
              doubleClickZoom:
                options.doubleClickZoom !== undefined ? options.doubleClickZoom : true,
              dragRotate: options.dragRotate !== undefined ? options.dragRotate : true,
            },
          });
        },
    };
...
function TiptapMapbox(props: NodeViewProps) {
  ...
  }, [resizing, resizeInitialMouseX, resizeInitialWidth, resize, handleTouchMove]);
      ...
      >
        <Mapbox
          ...
          showControls={
            editor?.isEditable
              ? false
              : node.attrs.scrollZoom || node.attrs.doubleClickZoom || node.attrs.dragRotate
          }
          scrollZoom={editor?.isEditable ? false : node.attrs.scrollZoom}
          doubleClickZoom={editor?.isEditable ? false : node.attrs.doubleClickZoom}
