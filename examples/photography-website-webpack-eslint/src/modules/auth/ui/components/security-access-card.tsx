...
import { formatLastActive, getDeviceDescription, getDeviceIcon } from '../../lib/utils';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div>
          <h2 className="text-xl font-semibold tracking-tight mb-1">Active Sessions</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {props.activeSessions
            ...
            .map((session) => {
              ...
              const deviceDescription = getDeviceDescription(parser, deviceType);
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="font-medium text-sm truncate">{deviceDescription}</h3>
                          {isCurrentSession && (
                            <Badge
                              variant="secondary"
