  ...
  const createPhoto = useMutation(
    trpc.photos.create.mutationOptions({
      onSuccess: async () => {
        ...
        await queryClient.invalidateQueries(trpc.home.getManyLikePhotos.queryOptions({}));
        await queryClient.invalidateQueries(trpc.home.getCitySets.queryOptions({}));
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          <div className="space-y-6 lg:col-span-3">
            ...
            <FormItem>
              ...
              <FormDescription>{address?.features?.[0]?.properties?.full_address}</FormDescription>
            </FormItem>
