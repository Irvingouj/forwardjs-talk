...
export function ShutterSpeedSelector({ value, onChange }: ShutterSpeedSelectorProps) {
  const closestSpeed = value ? findClosestShutterSpeed(value) : null;
  const [isCustom, setIsCustom] = useState(value !== undefined && closestSpeed === null);
  ...
  return (
    <div className="space-y-2">
      ...
      >
        <SelectTrigger>
          <SelectValue placeholder="Select shutter speed">{displayValue}</SelectValue>
        </SelectTrigger>
