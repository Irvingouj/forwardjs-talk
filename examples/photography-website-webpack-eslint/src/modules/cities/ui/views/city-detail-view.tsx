...
import { ArrowLeft, MapPin, Image as ImageIcon, Star, Heart, StarOff } from 'lucide-react';
...
export function CityDetailView({ city }: CityDetailViewProps) {
  ...
  const { data: cityData } = useSuspenseQuery(trpc.city.getOne.queryOptions({ city }));
  ...
  const updateCoverPhoto = useMutation(trpc.city.updateCoverPhoto.mutationOptions());
  ...
  const updateDescription = useMutation(
    trpc.city.updateDescription.mutationOptions({
      onSuccess: async () => {
        ...
        await queryClient.invalidateQueries(trpc.travel.getCitySets.queryOptions({}));
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-start justify-between mb-6">
              <div>
                <h1 className="text-4xl font-bold tracking-tight mb-2">{cityData.city}</h1>
              ...
              <Form {...form}>
                ...
                >
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-base font-medium">City Description</FormLabel>
                        <FormControl>
                          <Textarea
                            {...field}
          ...
          <div key={photo.id} className="space-y-4">
            <div className="relative space-y-4 flex items-center justify-center bg-gray-50 dark:bg-muted h-[80vh] p-20">
              ...
              <div className="absolute bottom-3 right-3 flex items-center gap-2">
                <Button variant="outline" size="icon" onClick={() => handleSetCover(photo.id)}>
            ...
            <div className="flex flex-col w-full items-center justify-center">
              ...
              <p className="text-xs text-muted-foreground">
                {photo.dateTimeOriginal ? format(photo.dateTimeOriginal, 'd MMM yyyy') : ''}
              </p>
            </div>
          </div>
        ))}
