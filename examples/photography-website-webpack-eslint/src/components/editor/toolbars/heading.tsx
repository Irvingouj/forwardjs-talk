  ...
  ({ className, ...props }, ref) => {
    ...
    const editorState = useEditorState({
      ...
      selector: (ctx) => ({
        ...
        canHeading: ctx.editor.can().chain().focus().toggleHeading({ level: 1 }).run() ?? false,
      }),
    });
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="start">
          <DropdownMenuItem
            ...
            className={cn('flex items-center gap-2', editorState.isH1 && 'bg-accent')}
          >
            <Heading1Icon className="h-4 w-4" />
            <span>Heading 1</span>
          </DropdownMenuItem>
          <DropdownMenuItem
            ...
            className={cn('flex items-center gap-2', editorState.isH2 && 'bg-accent')}
          >
            <Heading2Icon className="h-4 w-4" />
            <span>Heading 2</span>
          </DropdownMenuItem>
          <DropdownMenuItem
            ...
            className={cn('flex items-center gap-2', editorState.isH3 && 'bg-accent')}
          >
            <Heading3Icon className="h-4 w-4" />
            <span>Heading 3</span>
          </DropdownMenuItem>
